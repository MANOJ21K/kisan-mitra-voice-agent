...
# --- external data sources (used by src/tools.py) --------------------------
# Open-Meteo is keyless. data.gov.in needs a free key; the string below is the
# public sample key (heavily rate-limited) so a fresh clone runs out of the box.
# Get your own at https://data.gov.in and set DATA_GOV_IN_API_KEY in .env.
