...
> Vendored from the [GLINCKER claude-code-marketplace](https://github.com/GLINCKER/claude-code-marketplace/blob/main/skills/documentation/readme-generator/SKILL.md)
> (Apache-2.0). Author attribution preserved; a few repo-relative links were adjusted to
> point back at the upstream source since this copy lives in a different repository.
...
See the upstream marketplace for companion skills (changelog-generator,
api-doc-generator, license-picker): <https://github.com/GLINCKER/claude-code-marketplace>
...
Apache License 2.0. Original skill © GLINCKER Team — see the upstream repository:
<https://github.com/GLINCKER/claude-code-marketplace>
